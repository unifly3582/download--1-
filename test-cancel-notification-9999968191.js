// Test order cancellation WhatsApp notification for 9999968191
require('dotenv').config({ path: '.env.local' });

async function testCancelNotification() {
  console.log('📤 Testing Order Cancellation WhatsApp Notification\n');
  ...
  try {
    ...
    if (response.ok) {
      ...
      console.log('Your Buggly order (Order ID: 5077) has been cancelled.');
      console.log('');
      console.log('Please contact our customer care team on whatsapp for more');
      console.log('information.');
      console.log('');
      console.log('-Buggly farms -Happy chickens');
      console.log('━'.repeat(60));
    } else {
